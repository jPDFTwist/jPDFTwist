...
public class FileTreeTableModel extends DefaultTreeTableModel implements SwapObserver {
    ...
    /**
     * Get the number of File children from a node
     * In order to get all files send as parameter the root node
     * 
    ...
    /**
     * Get the number of Folder nodes from a starting node
     * In order to get all folders send as parameter the root node
     * 
     * @param node the first node
     * @return count of file nodes
     */
