...
public class TreeTableComponent extends JPanel implements PreviewHandler {
  ...
  //  private PdfPTable pdfTable;
	...
	public TreeTableComponent(final String[] headers, final Class[] classes) {
		...
		super.setLayout((LayoutManager) new FormLayout("f:p:g,f:p:g,f:p:g,f:p:g,f:p:g,f:p:g,f:p:g,f:p:g,f:p:g,f:p:g,f:p:g,f:p:g,f:p:g,f:p:g,f:p:g,f:p:g,f:p:g,f:p:g,f:p:g,f:p:g,f:p:g,f:p:g,f:p:g,f:p:g,f:p:g,f:p:g,f:p:g", "f:p:g, f:p"));
...
private void createPdf()
{
	...
	String date=Integer.toString(now.getDayOfMonth())+"_"+now.getMonth()+"_"+Integer.toString(now.getYear());
	String time=Integer.toString(now.getHour())+"_"+Integer.toString(now.getMinute())+"_"+Integer.toString(now.getSecond());
	...
	try {
		...
		g2.dispose();
		com.itextpdf.text.Image image=com.itextpdf.text.Image.getInstance((PdfTemplate)tp);
		image.scalePercent(43.0f);
...
public java.awt.Image getImageFromComponent(JComponent component)
{
	...
	BufferedImage image=new BufferedImage(treeTable.getWidth(),component.getHeight(),BufferedImage.TYPE_INT_RGB);
	component.paint(image.getGraphics());
	return image;
	
}

public void addImageToDocument(Document document,PdfWriter writer,java.awt.Image img) throws IOException, DocumentException
{
	com.itextpdf.text.Image image=com.itextpdf.text.Image.getInstance(writer,img,1);
	
	/**com.itextpdf.text.Rectangle rect=new com.itextpdf.text.Rectangle(image.getScaledWidth(), image.getScaledHeight());
...

{
   JFileChooser fc = new JFileChooser();
	...
	//String filepath="C:\\jProject\\Untitled\\Jtree_details20_SEPTEMBER_2020_23_21_37.csv";
    ...
    String[] columNames = new String[] {"File", "ID", "PaperSize", "Orientation", "Color Depth", "Size", "Pages",
