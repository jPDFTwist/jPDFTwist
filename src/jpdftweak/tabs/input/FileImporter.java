...
public class FileImporter implements Runnable {
    ...
    private boolean useTempFiles, optimizePDF,
            autoRestrictionsOverwrite, autoRestrioctionsNew;
    ...
    private void importFile(File file) {
        ...
        try {
            FileUserObject.SubType subType
                = SupportedFileTypes.isPDF(file.getAbsolutePath())
                    ? FileUserObject.SubType.PDF
                    : FileUserObject.SubType.IMAGE;

            FileNodeFactory fileNodeFactory = NodeFactory.getFileNodeFactory(
                    UserObjectType.REAL_FILE, subType);
