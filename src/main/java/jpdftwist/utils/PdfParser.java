...
import jpdftwist.tabs.input.password.PasswordObject;
import jpdftwist.tabs.input.password.PdfUnlockDialog;
...
public class PdfParser {
	...
	public static PdfReader openWithPass(String filepath, boolean optimize, boolean autoRestrictionsOverwrite,
			boolean autoRestrictionsNew) throws IOException {
		PasswordObject unlockInfo = PdfUnlockDialog.askForPassword(null, filepath, autoRestrictionsOverwrite,
				autoRestrictionsNew);
