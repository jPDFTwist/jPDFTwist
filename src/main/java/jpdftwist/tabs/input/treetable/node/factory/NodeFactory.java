...
public class NodeFactory {
	...
	public static FileNodeFactory getFileNodeFactory(UserObjectType type, FileUserObject.SubType subType) {
		switch (type) {
		case REAL_FILE:
	...
	private static FileNodeFactory getRealFileNodeFactory(FileUserObject.SubType subType) {
		switch (subType) {
		case PDF:
	...
	private static FileNodeFactory getVirtualFileNodeFactory(FileUserObject.SubType subType) {
		switch (subType) {
		case PDF:
