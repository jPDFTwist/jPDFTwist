...
public class WatermarkPreviewComponent extends JComponent implements MouseListener, MouseMotionListener, ComponentListener {
    ...
    public static WatermarkPreviewComponent createPreviewBox() {
        final WatermarkPreviewComponent preview = new WatermarkPreviewComponent();
