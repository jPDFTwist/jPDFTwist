...
public class WatermarkOptionsPanel extends javax.swing.JPanel {
	...
	private javax.swing.JCheckBox cropmarksCheckBox;
...
//    }
	...
	private void initComponents() {
		...
		cropmarksCheckBox = new javax.swing.JCheckBox();
		...
		jLabel2.setText("Font / Cropmarks Color:");
		...
		cropmarksCheckBox.setText("Small Caps");
		cropmarksCheckBox.addItemListener(this::cropmarksCheckBoxItemStateChanged);
		cropmarksCheckBox.setEnabled(false);
		...
		widthSpinner.setModel(new javax.swing.SpinnerNumberModel(0.0f, 0.0f, null, 0.25f));
		widthSpinner.addChangeListener(this::widthSpinnerStateChanged);

		jLabel6.setText("Height:");

		heightSpinner.setModel(new javax.swing.SpinnerNumberModel(0.0f, 0.0f, null, 0.25f));
		...
		backgroundButton.setSelectedColor(new java.awt.Color(0, 255, 0));

		horizontalSpinner.setModel(new javax.swing.SpinnerNumberModel(0.0f, null, null, 0.25));
		horizontalSpinner.addChangeListener(this::horizontalSpinnerStateChanged);

		verticalSpinner.setModel(new javax.swing.SpinnerNumberModel(0.0f, null, null, 0.25f));
		...
		typeComboBox
				.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "1, 2, 3", "I, II, III", "i, ii, iii",
						"A, B, C", "a, b, c", "Bates Numbering", "Repeated Text", "Image", "Variable Text", 
						"Cropmarks  0.25 inch", "Cropmarks 10.0 mm", "Vector", "Empty" }));
								...
								.addGroup(layout.createSequentialGroup().addGroup(layout
										...
										.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
												...
												.addGroup(layout.createSequentialGroup().addGroup(layout
														...
														.addGroup(layout.createSequentialGroup()
																.addComponent(cropmarksCheckBox)
																.addGap(21, 21, 21)
...
//								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
								...
								.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
										.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
												.addComponent(cropmarksCheckBox).addComponent(jLabel12))
										.addComponent(fontColorButton, javax.swing.GroupLayout.PREFERRED_SIZE,
												javax.swing.GroupLayout.DEFAULT_SIZE,
												javax.swing.GroupLayout.PREFERRED_SIZE))
								.addGap(7, 7, 7)
	...
	private void cropmarksCheckBoxItemStateChanged(java.awt.event.ItemEvent evt) {
		previewModel.setCropmarks(cropmarksCheckBox.isSelected());
		if (style != null)
			style.setCropmarks(cropmarksCheckBox.isSelected());
	}
	...
	public void setStyle(WatermarkStyle style) {
		...
		cropmarksCheckBox.setSelected(style.isCropmarks());
